...
<?php
	if (isset($_POST["submit"])) {
		...
		$from = 'POLO INSURANCE AppointmentForm'; 
		$to = 'polo@link192.com'; 
		$subject = 'Appointment Requestfrom POLO INSURANCE ';
		
		$body ="Client ID: $id\n\nAgent: $name\n\nService: $service\n\nDate & Time: $time";
		// Check if name has been entered
		if (!$_POST['name']) {
			$errName = 'Please enter the agent name';
		}
...
<section id="main">
	...
	<div class="contentbg">
			...
			<div class="col-sm-3">
				...
				<a href="agents.php" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Agents </span></a>
				<a href="quote.php" class="list-group-item"><span class="glyphicon glyphicon-euro" aria-hidden="true"></span> Quick Quote </span></a>
				...
				<h3 class="panel-title">Welcome to POLO INSURANCE</h3>
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" role="form" method="post" action="RequestAnAppointment.php">
							...
							<label for="name" class="col-sm-2 control-label">Agent</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="name" name="name" placeholder="Agent Name" value="<?php echo $Agent; ?>">
								<span class="help-block">ie. Eimer, Andrea, Maria, Cathal, Conor or Liam</span>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<span class="help-block">ie. Health Insurance, Travel Insurance, Car Insurance</span>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<span class="help-block">ie. December 22 at 3pm</span>
